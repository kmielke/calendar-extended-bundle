...
//            }
    ...
    protected function compileDays()
    {
        ...
        //Get all events
        $arrAllEvents = $this->getAllEventsExt($this->cal_calendar, $this->weekBegin, $this->weekEnd, [$this->cal_holiday]);
        ...
        for ($i = 0; $i < 7; ++$i) {
            ...
            $class = 0 === $intCurrentDay || 6 === $intCurrentDay || 7 === $intCurrentDay ? 'weekend' : 'weekday';
